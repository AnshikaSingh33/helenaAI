...
var CallbackManager = class _CallbackManager extends BaseCallbackManager {
  ...
  static _configureSync(inheritableHandlers, localHandlers, inheritableTags, localTags, inheritableMetadata, localMetadata, options) {
    ...
    for (const { contextVar, inheritable = true, handlerClass, envVar } of _getConfigureHooks()) {
      ...
      if (handler !== void 0) {
        if (!(callbackManager == null ? void 0 : callbackManager.handlers.some((h) => h.name === handler.name))) {
          callbackManager == null ? void 0 : callbackManager.addHandler(handler, inheritable);
        }
      }
    }
...
@langchain/core/dist/utils/fast-json-patch/src/duplex.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GW3RMHTD.js.map
